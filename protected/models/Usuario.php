...
class Usuario extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('dni, idciudad, estado, admin, telefono', 'numerical', 'integerOnly' => true),
            array('usuario, pass, email', 'length', 'max' => 50),
            array('email', 'email'),
            array('nombre, apellido, direccion, telefono', 'length', 'max' => 50),
    ...
    public function getCiudad($defaultProvincia=1) {
        $ciudades = Ciudad::model()->findAll("idprovincia=?",array($defaultProvincia));
        return CHtml::listData($ciudades, "id", "nombre");
    }*/
