...
class AutorController extends Controller {
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['Autor'])) {
            if(($_POST['Autor']['nombre']!='')&&($_POST['Autor']['apellido']!='')){
                $model->nombreyapellido = $_POST['Autor']['nombre'].' '.$_POST['Autor']['apellido'];
                if ($model->save())
                    $this->redirect(array('view', 'id' => $model->id));
            }else
                Yii::app()->user->setFlash('error', 'Verifique los datos enviados. Recuerde:<br/>- Nombre y Apellido son datos obligatorios');
        }
