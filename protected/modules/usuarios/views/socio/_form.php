<div class="form">
    ...
    <?php else: ?>
        <div class="row" style="margin-bottom:20px;">
            ...
            <?php echo $form->dropDownList($model, 'idbiblioteca', CHtml::listData(Empleado::model()->findAll('idusuario=?', array(Yii::app()->user->id)), 'idbiblioteca', 'idbiblioteca0.nombre'), array('class' => 'span3', 'style' => 'margin:0 0 10px 15px;', 'empty' => 'Biblioteca')); ?>
